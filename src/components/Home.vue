    ...
    <div class="flex flex-col justify-center items-center text-white">
        ...
        <div class="lg:flex lg:flex-row">
            ...
            <div class="flex flex-col justify-center items-center lg:mt-24 px-10">
                ...
                <h2 class="text-3xl font-bold text-center mt-6 xs:text-xl">Full-Stack Developer</h2>
                ...
                <div class="flex justify-center items-center gap-6 mt-10">
                    ...
                    <button aria-label="GitHub" class="transition duration-300 ease-in-out hover:scale-[1.3]">
                        <a href="https://github.com/sergiogonzalezyes"><i class="fa-brands fa-github text-3xl cursor-pointer"></i></a>
                    </button>
        ...
        <div class="flex flex-col justify-center items-center mt-10 lg:w-3/5">
